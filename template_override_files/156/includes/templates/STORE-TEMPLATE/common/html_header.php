...
<?php
  ...
  if (count($lng->catalog_languages) > 1) {
    foreach ($lng->catalog_languages as $key => $value) {
        ...
        //@mesnitu I guess this line is now in zv156. Except the FALSE on zen_href_link. Still didn't tested, but if not needed, this file can be deleted from installation
